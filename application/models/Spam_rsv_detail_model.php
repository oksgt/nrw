...
class Spam_rsv_detail_model extends CI_Model {
 
    var $table = 'tb_spam_rsv_detail';
    var $view  = 'v_spam_rsv_detail';
    var $column_order = array('id','step', 'step_name', 'id_spam_node','debit_input','debit_distribusi','air_terjual','kehilangan_air','jml_pelanggan','is_del','input_date','name'); //set column field database for datatable orderable
    var $column_search = array('id','step', 'step_name', 'id_spam_node','debit_input','debit_distribusi','air_terjual','kehilangan_air','jml_pelanggan','is_del','input_date','name'); //set column field database for datatable searchable just firstname , lastname , address are searchable
