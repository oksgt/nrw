                            ...
                            <div class="modal-body">
                                <form id="form" method="post" onsubmit="return false;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <small id="input_air_baku_error_detail" class="form-text text-danger"></small>
                                    </div>
                                    <div class="form-group">
                                        <label for="input_debit">Debit (l/dt)</label>
                                        <input type="text" class="form-control" id="input_debit" name="input_debit">
                                        <small id="input_debit_error_detail" class="form-text text-danger"></small>
                                    </div>
                                    <div class="form-group">
                                        <label for="input_kapasitas_pompa">Kapasitas Pompa (l/dt)</label>
                                        <input type="text" class="form-control" id="input_kapasitas_pompa" name="input_kapasitas_pompa">
                                        <small id="input_kapasitas_pompa_error_detail" class="form-text text-danger"></small>
                                    </div>
                                    <div class="form-group">
                                        <label for="input_lokasi">Lokasi</label>
                                        <input type="text" class="form-control" id="input_lokasi" name="input_lokasi">
                                        <small id="input_lokasi_error_detail" class="form-text text-danger"></small>
                                    </div>
                            </div>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                table = $('#table').DataTable({
                    ...
                    "ajax": {
                        "url": "<?php echo site_url('admin/IntakeDetail/ajax_list/') ?>" + <?= $node_id ?>,
                        "type": "POST"
                    },
                    "columnDefs": [{
                        "targets": [-1],
                ...
                setInputFilter(document.getElementById("input_debit"), function(value) {
            ...
            function form_validation() {
                $('#form').on('submit', function(event) {
                    ...
                    $.ajax({
                        url: "<?php echo site_url('admin/IntakeDetail/validation') ?>",
                        method: 'post',
                        data: $(this).serialize(),
                        dataType: 'json',
                        beforeSend: function() {
            ...
            function save() {
                var url;
                if (save_method == "add") {
                    url = "<?php echo site_url('admin/IntakeDetail/') ?>" + "insert/";
                } else {
                    url = "<?php echo site_url('admin/IntakeDetail/') ?>" + "update/";
                }
                var form = $('#form')[0];
            ...
            function detail(id) {
                reset_validation();
                $.ajax({
                    url: "<?php echo site_url('admin/IntakeDetail/') ?>" + "detail/" + id,
                    method: 'GET',
                    dataType: 'json',
                    success: function(data) {
            ...
            function hapus_data(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "<?php echo site_url('admin/IntakeDetail/') ?>" + "delete/" + id,
                            method: "GET",
                            dataType: 'json',
                            success: function(data) {
                                if (data.status) {
