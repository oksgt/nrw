                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="form" method="post" onsubmit="return false;">
                                    ...
                                    <div class="form-group">
                                        <label for="input_debit_input">Debit Input (l/dt)</label>
                                        <input type="text" class="form-control float" id="input_debit_input" name="input_debit_input">
                                        <small id="input_debit_input_error_detail" class="form-text text-danger"></small>
                                    </div>
                                    <div class="form-group">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                table = $('#table').DataTable({
                    ...
                    "ajax": {
                        "url": "<?php echo site_url('admin/RsvDetail/ajax_list/') ?>" + <?= $node_id ?>,
                        "type": "POST"
                    },
                    "columnDefs": [{
                        "targets": [-1],
                ...
                setInputFilter(document.getElementById("input_debit_input"), function(value) {
            ...
            function form_validation() {
                $('#form').on('submit', function(event) {
                    ...
                    var input_list_error = [
                        'input_debit_input_error_detail',
                    ...
                    $.ajax({
                        url: "<?php echo site_url('admin/RsvDetail/validation') ?>",
                        method: 'post',
                        data: $(this).serialize(),
                        dataType: 'json',
                        beforeSend: function() {
            ...
            function save() {
                var url;
                if (save_method == "add") {
                    url = "<?php echo site_url('admin/RsvDetail/') ?>" + "insert/";
                } else {
                    url = "<?php echo site_url('admin/RsvDetail/') ?>" + "update/";
                }
                var form = $('#form')[0];
            ...
            function detail(id) {
                reset_validation();
                $.ajax({
                    url: "<?php echo site_url('admin/RsvDetail/') ?>" + "detail/" + id,
                    method: 'GET',
                    dataType: 'json',
                    success: function(data) {
                        ...
                        $('[name=input_debit_input]').val(data.debit_input);
            ...
            function hapus_data(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "<?php echo site_url('admin/RsvDetail/') ?>" + "delete/" + id,
                            method: "GET",
                            dataType: 'json',
                            success: function(data) {
                                if (data.status) {
