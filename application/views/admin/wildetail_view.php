                            ...
                            <div class="modal-body">
                                <form id="form" method="post" onsubmit="return false;">
                                    ...
                                    <div class="form-group">
                                        <label for="input_sistem">Debit Input (l/dt)</label>
                                        <input type="text" class="form-control float" id="input_sistem" name="input_sistem">
                                        <small id="input_sistem_error_detail" class="form-text text-danger"></small>
                                    </div>
                                    <div class="form-group">
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                table = $('#table').DataTable({
                    ...
                    "buttons": ["copy", "csv", "excel", "pdf", "print", "colvis"],
                    "ajax": {
                        "url": "<?php echo site_url('admin/WilDetail/ajax_list/') ?>" + <?= $node_id ?>,
                        "type": "POST"
                    },
                    "columnDefs": [{
                        "targets": [-1],
                ...
                setInputFilter(document.getElementById("input_sistem"), function(value) {
            ...
            function form_validation() {
                $('#form').on('submit', function(event) {
                    ...
                    $.ajax({
                        url: "<?php echo site_url('admin/WilDetail/validation') ?>",
                        method: 'post',
                        data: $(this).serialize(),
                        dataType: 'json',
                        beforeSend: function() {
            ...
            function save() {
                var url;
                if (save_method == "add") {
                    url = "<?php echo site_url('admin/WilDetail/') ?>" + "insert/";
                } else {
                    url = "<?php echo site_url('admin/WilDetail/') ?>" + "update/";
                }
                var form = $('#form')[0];
            ...
            function detail(id) {
                reset_validation();
                $.ajax({
                    url: "<?php echo site_url('admin/WilDetail/') ?>" + "detail/" + id,
                    method: 'GET',
                    dataType: 'json',
                    success: function(data) {
                        ...
                        $('[name=input_sistem]').val(data.input_sistem);
            ...
            function hapus_data(id) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "<?php echo site_url('admin/WilDetail/') ?>" + "delete/" + id,
                            method: "GET",
                            dataType: 'json',
                            success: function(data) {
                                if (data.status) {
