        ...
        function (e, t, n) {
            ...
            class i {
                ...
                removeReouteConnectionSelected() {
                    this.dispatch("connectionUnselected", !0),
                        this.reroute_fix_curvature &&
                            this.connection_selected.parentElement.querySelectorAll(".main-path, .main-path-bg").forEach((e, t) => {
                    ...
                    switch (this.ele_selected.classList[0]) {
                        ...
                        case "main-path-bg":
                            null != this.node_selected && (this.node_selected.classList.remove("selected"), (this.node_selected = null), this.dispatch("nodeUnselected", !0)),
                                ...
                                (this.connection_selected = this.ele_selected),
                                this.connection_selected.classList.add("selected");
                            const tt = this.connection_selected.parentElement.classList;
                            this.dispatch("connectionSelected", { output_id: tt[2].slice(14), input_id: tt[1].slice(13), output_class: tt[3], input_class: tt[4] }),
                                this.reroute_fix_curvature &&
                                    this.connection_selected.parentElement.querySelectorAll(".main-path, .main-path-bg").forEach((e, tt) => {
                                        e.classList.add("selected");
                                    });
                            break;
                ...
                position(e) {
                    ...
                    if (this.drag_point) {
                        ...
                        if (this.reroute_fix_curvature) {
                            (r -= this.ele_selected.parentElement.querySelectorAll(".main-path, .main-path-bg").length - 1), r < 0 && (r = 0);
                        }
                        const h = e.slice(5),
                ...
                drawConnection(e) {
                    ...
                    var nn = document.createElementNS("http://www.w3.org/2000/svg", "path");
                    nn.classList.add("main-path-bg"), nn.setAttributeNS(null, "d", ""), t.classList.add("connection"), t.append(nn), this.precanvas.append(t);

                    var n = document.createElementNS("http://www.w3.org/2000/svg", "path");
                    n.classList.add("main-path"), n.setAttributeNS(null, "d", ""), t.classList.add("connection"), t.append(n), this.precanvas.append(t);
                ...
                updateConnection(e, t) {
                    ...
                    var l = this.connection_ele.children[1],
                        c = this.ele_selected.offsetWidth / 2 + (this.ele_selected.getBoundingClientRect().x - n.getBoundingClientRect().x) * s,
                        d = this.ele_selected.offsetHeight / 2 + (this.ele_selected.getBoundingClientRect().y - n.getBoundingClientRect().y) * o,
                        a = e * (this.precanvas.clientWidth / (this.precanvas.clientWidth * this.zoom)) - this.precanvas.getBoundingClientRect().x * (this.precanvas.clientWidth / (this.precanvas.clientWidth * this.zoom)),
                        r = t * (this.precanvas.clientHeight / (this.precanvas.clientHeight * this.zoom)) - this.precanvas.getBoundingClientRect().y * (this.precanvas.clientHeight / (this.precanvas.clientHeight * this.zoom)),
                        ...
                        if (!1 === l) {
                            if (
                                ...
                                var a = document.createElementNS("http://www.w3.org/2000/svg", "svg"),
                                    ...
                                    rr = document.createElementNS("http://www.w3.org/2000/svg", "path");

                                    rr.classList.add("main-path-bg"),
                                    rr.setAttributeNS(null, "d", ""),
                                    aa.classList.add("connection"),
                                    aa.classList.add("node_in_node-" + t),
                                    aa.classList.add("node_out_node-" + e),
                                    aa.classList.add(n),
                                    aa.classList.add(i),
                                    aa.append(rr),
                                    this.precanvas.append(aa),
                ...
                updateConnectionNodes(e) {
                    ...
                    Object.keys(f).map(function (t, n) {
                        if (null === f[t].querySelector(".point")) {
                            ...
                            // if(f[t].children > 1){
                                ...
                                f[t].children[1].setAttributeNS(null, "d", n);
                            // } else {
                            //     f[t].children[0].setAttributeNS(null, "d", n);
                            // }
                            // f[t].children[1].setAttributeNS(null, "d", n);
                            console.log("++++");
                            console.log(f[t].children);
                            console.log("----");
                            // if( f[t].children[1] !== "undefined"){
                            //     f[t].children[1].setAttributeNS(null, "d", n);
                            // }
                        } else {
                            ...
                            n.forEach((t, a) => {
                                ...
                                a
                                    ...
                                    : f[t].children[0].setAttributeNS(null, "d", o); f[t].children[1].setAttributeNS(null, "d", o);
                        }
                    });
                    ...
                    Object.keys(g).map(function (t, n) {
                        if (null === g[t].querySelector(".point")) {
                            ...
                            // console.log(g[t].children[1]);

                            // if(g[t].children > 1){
                                g[t].children[0].setAttributeNS(null, "d", n);
                                g[t].children[1].setAttributeNS(null, "d", n);
                            // } else {
                            //     g[t].children[0].setAttributeNS(null, "d", n);
                            // }

                            // if( g[t].children[1] !== "undefined"){
                            //     g[t].children[1].setAttributeNS(null, "d", n);
                            // }
                        } else {
                            ...
                            n.forEach((t, a) => {
                                ...
                                a
                                    ...
                                    : g[t].children[0].setAttributeNS(null, "d", o); g[t].children[1].setAttributeNS(null, "d", o);
                        }
                    });
                }
                dblclick(e) {
                ...
                createReroutePoint(e) {
                    ...
                    let d = 0;
                    if (this.reroute_fix_curvature) {
                        const t = e.parentElement.querySelectorAll(".main-path, .main-path-bg").length;
                        var a = document.createElementNS("http://www.w3.org/2000/svg", "path");
                        if (
                            (a.classList.add("main-path"), a.setAttributeNS(null, "d", ""), e.parentElement.insertBefore(a, e.parentElement.children[t]), 1 === t) && 
                            (a.classList.add("main-path-bg"), a.setAttributeNS(null, "d", ""), e.parentElement.insertBefore(a, e.parentElement.children[t]), 1 === t)
                            ) e.parentElement.append(o);
                        else {
                            const n = Array.from(e.parentElement.children).indexOf(e);
                            (d = n), e.parentElement.insertBefore(o, e.parentElement.children[n + t + 1]);
                        }
                    } else e.parentElement.append(o);
                    const r = t.slice(5),
                    ...
                    void 0 === this.drawflow.drawflow[this.module].data[r].outputs[i].connections[h].points && (this.drawflow.drawflow[this.module].data[r].outputs[i].connections[h].points = []),
                        this.reroute_fix_curvature
                            ? (d > 0
                              ...
                              e.parentElement.querySelectorAll(".main-path, .main-path-bg").forEach((e, t) => {
                                  e.classList.remove("selected");
                              }))
                            : this.drawflow.drawflow[this.module].data[r].outputs[i].connections[h].points.push({ pos_x: l, pos_y: c }),
                            ...
                            o.classList.add("input"),
                                ...
                                Object.keys(e.inputs[n].connections).map(function (i, s) {
                                    var o = document.createElementNS("http://www.w3.org/2000/svg", "svg"),
                                        ...
                                        ll = document.createElementNS("http://www.w3.org/2000/svg", "path");

                                        ll.classList.add("main-path-bg"),
                                        ll.setAttributeNS(null, "d", ""),
                                ...
                                c.forEach((l, d) => {
                                    ...
                                    if (n && 0 === d)
                                        for (var u = 0; u < c.length; u++) {
                                            ...
                                            p.classList.add("main-path"), p.setAttributeNS(null, "d", ""), h.append(p);
                                            p.classList.add("main-path-bg"), p.setAttributeNS(null, "d", ""), h.append(p);
                                        }
